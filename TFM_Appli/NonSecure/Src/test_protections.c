...
const TestProtection_t aProtectTests[] =
{
    ...
    { (uint32_t) &GTZC_TZIC1->IER3, "GTZC1_TZIC IER3", TEST_WRITE_PERIPH, NOT_APPLICABLE, DENIED},
    { (uint32_t) &GTZC_TZIC2->IER3, "GTZC2_TZIC IER3", TEST_READ_PERIPH, NOT_APPLICABLE, DENIED},
